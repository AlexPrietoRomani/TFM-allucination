...
class AgentGraph:
    def __init__(self, provider: str = None, model_id: str = None, force_local: bool = False, vector_store=None):
        self.nodes = AgentNodes(provider, model_id, force_local=force_local, vector_store=vector_store)
