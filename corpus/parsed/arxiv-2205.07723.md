...
Según Pest presence prediction using interpretable machine learning (2022), Class: Accuracy, Case B: 0.75 ± 0.03.
Según Pest presence prediction using interpretable machine learning (2022), Class: AUC, Case B: 0.83 ± 0.03.
Según Pest presence prediction using interpretable machine learning (2022), Class: F1 score, Case A: Pest absence, Case B: 0.75 ± 0.04.
Según Pest presence prediction using interpretable machine learning (2022), Class: F1 score, Case A: Pest presence, Case B: 0.74 ± 0.04.
...
Según Pest presence prediction using interpretable machine learning (2022), Case A: Features, Case A: Scores, Case B: Features, Case B: Scores.
Según Pest presence prediction using interpretable machine learning (2022), Case A: Catches t-1, Case A: 0.29, Case B: WS (min) - AP acc., Case B: 0.13.
Según Pest presence prediction using interpretable machine learning (2022), Case A: Catches t-2, Case A: 0.16, Case B: WS (max) - T at 0 m (max) acc., Case B: 0.12.
Según Pest presence prediction using interpretable machine learning (2022), Case A: T at 2 m (min), Case A: 0.15, Case B: RH (min) acc. - GDD, Case B: 0.12.
Según Pest presence prediction using interpretable machine learning (2022), Case A: cos(DoY), Case A: 0.13, Case B: cos(DoY), Case B: 0.11.
Según Pest presence prediction using interpretable machine learning (2022), Case A: GI, Case A: 0.13, Case B: T at 0 m (max) acc. - cos(DoY), Case B: 0.11.
Según Pest presence prediction using interpretable machine learning (2022), Case A: RH (max), Case A: 0.13, Case B: WS (max), Case B: 0.10.
Según Pest presence prediction using interpretable machine learning (2022), Case A: RH acc. (max), Case A: 0.12, Case B: NDMI - WS (min), Case B: 0.09.
Según Pest presence prediction using interpretable machine learning (2022), Case A: NDWI, Case A: 0.11, Case B: GCVI, Case B: 0.09.
Según Pest presence prediction using interpretable machine learning (2022), Case A: Lon, Case A: 0.11, Case B: NDVI - NDMI, Case B: 0.09.
Según Pest presence prediction using interpretable machine learning (2022), Case A: GCVI, Case A: 0.10, Case B: GCVI - sin(DoY), Case B: 0.09.
